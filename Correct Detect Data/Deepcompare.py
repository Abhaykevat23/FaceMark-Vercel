...
class_image = cv2.imread('D:\Mini Project\FaceMark\Python Server\My Try\Whole class\IMG_8656.jpg')
...
folder_path = 'D:\Mini Project\FaceMark\Python Server\My Try\My Class Data'  # Replace with the path to your folder
